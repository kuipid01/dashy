...
import ContainerDashboard from "@/app/(protected)/_components/container-dashboard";
import { ArrowDivNew } from "@/app/(protected)/_components/small-comps";
import type { LineProps, AreaProps, TooltipProps, DotProps } from "recharts";
...
const Tooltip = dynamic<TooltipProps<number, string>>(
  () =>
    import("recharts").then(
      (mod) => mod.Tooltip as React.ComponentType<TooltipProps<number, string>>
    ),
  { ssr: false }
);
