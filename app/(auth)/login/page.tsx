    ...
    <div className=" flex  flex-1 flex-col bg-[#F7F7F8] h-full p-3">
      <div className="flex justify-center items-center flex-1">
        ...
        >
          ...
          <button className="w-full  text-zinc-900 h-[40px] font-medium hover:bg-zinc-100 py-1 rounded-md border border-zinc-400 flex justify-center items-center gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
